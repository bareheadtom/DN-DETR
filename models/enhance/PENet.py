...
def adjust_size_for_odd(input_tensor):
...
class PENet(nn.Module):
    ...
    def __init__(self,
        ...
        #self.cross_attn = MultiheadAttention(3, 3, dropout=0.1)
    ...
    def forward(self, x):
        ...
        return out
        # y1 = out.flatten(2).permute(2,0,1)
        # z = self.cross_attn(x1,y1,y1)
        # print("x1.shape",x1.shape)
        # print("y1.shape",y1.shape)
        # print("z.shape",z.shape,z.permute(1,2,0).contiguous().view(bs,c,h,w).shape)

        # return z.permute(1,2,0).contiguous().view(bs,c,h,w)
        #return out
